        ...
        <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-center items-center text-white bg-black/60">
                <Card className="w-[450px] py-8 bg-cardform/50 backdrop-blur-md border border-white/20 shadow-lg text-white">
                    <CardHeader>
                        <CardTitle className="text-xl">Akses Tim CTF</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <form>
                            <div className="grid w-full items-center gap-4">
                                ...
                                <div className="flex flex-col space-y-1.5 mt-3">
                                    <Label htmlFor="framework">Pilih Nomor Tim (1-29)</Label>
                                    <Select disabled={sesi === ""} onValueChange={(value) => setNomorTim(value)}>
                                        <SelectTrigger className="w-full cursor-pointer">
                                            <SelectValue placeholder="Pilih Nomor Tim" />
                                        </SelectTrigger>
                                        <SelectContent className="bg-cardform/50 max-h-52 backdrop-blur-md border border-white/20 shadow-lg text-white">
                                            {getNomorTim().map((nomor) => (
                                            <SelectItem key={nomor} value={String(nomor)} className="cursor-pointer">
                                                Tim {nomor}
                                            </SelectItem>
                                            ))}
                                        </SelectContent>
                    ...
                    <CardFooter className="flex justify-between">
                        ...
                        <Button 
                            ...
                            onClick={() => {
                                ...
                                Cookies.set("timData", JSON.stringify({ sesi, nomorTim }), { expires: 1 });
                                router.push('/kirim-flag')
                            }}
                        >
                            Lanjut
                        </Button>
